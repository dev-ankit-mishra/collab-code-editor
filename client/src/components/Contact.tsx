  ...
  return (
    <section className="flex flex-col min-h-screen bg-gradient-to-br from-gray-900 via-neutral-950 to-zinc-900 px-52 py-6">
      <main className="flex flex-col flex-grow justify-center">
        <h1 className="text-5xl mb-2 text-center font-bold">Reach Out & Let’s Talk</h1>
        ...
        <form onSubmit={handleFormSubmit} className="space-y-7">
          ...
          <textarea id="message" name="message" rows={6} cols={30} placeholder="Type your message here..." className="w-full px-3 py-1 rounded-md bg-gray-800 border border-white/10  text-white placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-blue-500 transition-all"></textarea>
          </div>

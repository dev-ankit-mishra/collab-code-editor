  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-gray-900 via-neutral-950 to-zinc-900 px-52 py-6">
      <main className="flex flex-col  justify-center">
        ...
        <p className="text-xl text-center text-gray-400 mb-10">Feel free to reach out for collaborations, quotes, or inquiries.</p>
        ...
        <form onSubmit={handleFormSubmit} className="space-y-7">
          ...
          <Button className="w-full text-lg py-1.5 font-medium">
